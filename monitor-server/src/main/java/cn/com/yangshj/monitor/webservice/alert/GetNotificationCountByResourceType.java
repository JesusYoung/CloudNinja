...
/**
 * <p>getNotificationCountByResourceType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="getNotificationCountByResourceType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="resourceTypeId" type="{http://impl.notification.dev.bsm.mocha.com/}ArrayOfString"/>
...
@XmlType(name = "getNotificationCountByResourceType", propOrder = {
    "token",
    "moduleId",
    "eventGroupId",
    "resourceTypeId",
...
public class GetNotificationCountByResourceType {
    ...
    @XmlElement(required = true, nillable = true)
    protected ArrayOfString resourceTypeId;
     ...
     *     
     */
    public ArrayOfString getResourceTypeId() {
        return resourceTypeId;
    }

    /**
     * 设置resourceTypeId属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link ArrayOfString }
     *     
     */
    public void setResourceTypeId(ArrayOfString value) {
