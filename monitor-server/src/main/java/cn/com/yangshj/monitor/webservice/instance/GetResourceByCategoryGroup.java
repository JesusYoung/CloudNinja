...
/**
 * <p>getResourceByCategoryGroup complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="getResourceByCategoryGroup">
 *   &lt;complexContent>
...
@XmlType(name = "getResourceByCategoryGroup", propOrder = {
    "categoryGroupId"
})
public class GetResourceByCategoryGroup {

    @XmlElementRef(name = "categoryGroupId", namespace = "http://impl.instance.dev.bsm.mocha.com/", type = JAXBElement.class, required = false)
