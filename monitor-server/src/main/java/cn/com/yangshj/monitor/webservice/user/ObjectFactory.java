 ...
 * generated in the cn.com.yangshj.monitor.webservice.user package.
...
public class ObjectFactory {
    ...
    private final static QName _LoginOutToken_QNAME = new QName("http://impl.user.dev.bsm.mocha.com/", "token");
    private final static QName _GetUserPageResponseReturn_QNAME = new QName("http://impl.user.dev.bsm.mocha.com/", "return");
    ...
    /**
     * Create user new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.com.yangshj.monitor.webservice.user
     * 
     */
    ...
    public JAXBElement<String> createLoginOutToken(String value) {
        return new JAXBElement<String>(_LoginOutToken_QNAME, String.class, LoginOut.class, value);
    }
    ...
    public JAXBElement<String> createVerifyTokenToken(String value) {
        return new JAXBElement<String>(_LoginOutToken_QNAME, String.class, VerifyToken.class, value);
    }
    ...
    public JAXBElement<String> createGetUserPageToken(String value) {
        return new JAXBElement<String>(_LoginOutToken_QNAME, String.class, GetUserPage.class, value);
    }
    ...
    public JAXBElement<String2AnyTypeMap> createGetUserPageResponseReturn(String2AnyTypeMap value) {
        return new JAXBElement<String2AnyTypeMap>(_GetUserPageResponseReturn_QNAME, String2AnyTypeMap.class, GetUserPageResponse.class, value);
    }
    ...
    public JAXBElement<String> createLoginOutResponseReturn(String value) {
        return new JAXBElement<String>(_GetUserPageResponseReturn_QNAME, String.class, LoginOutResponse.class, value);
    }
    ...
    public JAXBElement<String2StringMap> createGetItomConfigResponseReturn(String2StringMap value) {
        return new JAXBElement<String2StringMap>(_GetUserPageResponseReturn_QNAME, String2StringMap.class, GetItomConfigResponse.class, value);
    }
    ...
    public JAXBElement<String> createGetItomConfigToken(String value) {
        return new JAXBElement<String>(_LoginOutToken_QNAME, String.class, GetItomConfig.class, value);
    }
