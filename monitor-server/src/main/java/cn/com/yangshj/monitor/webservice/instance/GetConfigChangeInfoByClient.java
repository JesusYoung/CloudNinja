...
/**
 * <p>getConfigChangeInfoByClient complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="getConfigChangeInfoByClient">
 *   &lt;complexContent>
...
@XmlType(name = "getConfigChangeInfoByClient", propOrder = {
    "token",
    "instanceId",
    "startTime",
    "endTime"
})
public class GetConfigChangeInfoByClient {
    ...
    @XmlElementRef(name = "startTime", namespace = "http://impl.instance.dev.bsm.mocha.com/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> startTime;
    @XmlElementRef(name = "endTime", namespace = "http://impl.instance.dev.bsm.mocha.com/", type = JAXBElement.class, required = false)
