...
/**
 * <p>getNotificationListByModifyClientTimeForApp complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="getNotificationListByModifyClientTimeForApp">
 *   &lt;complexContent>
...
@XmlType(name = "getNotificationListByModifyClientTimeForApp", propOrder = {
    "token",
    "moduleId",
    "eventGroupId",
    "objectName",
...
public class GetNotificationListByModifyClientTimeForApp {
