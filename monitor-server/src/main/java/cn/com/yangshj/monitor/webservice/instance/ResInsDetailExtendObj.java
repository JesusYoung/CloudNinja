...
/**
 * <p>ResInsDetailExtendObj complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ResInsDetailExtendObj">
 *   &lt;complexContent>
 ...
 *         &lt;element name="localtion" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "ResInsDetailExtendObj", namespace = "http://obj.dev.bsm.mocha.com", propOrder = {
    "availMetric",
    "baseInfo",
    "componentType",
    "configMetric",
...
public class ResInsDetailExtendObj {
    ...
    @XmlElementRef(name = "localtion", namespace = "http://obj.dev.bsm.mocha.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> localtion;
     ...
     *     
     */
    public JAXBElement<String> getLocaltion() {
        return localtion;
    }
     ...
     *     
     */
    public void setLocaltion(JAXBElement<String> value) {
