...
/**
 * <p>modifyDiscoveryRes complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="modifyDiscoveryRes">
 *   &lt;complexContent>
...
@XmlType(name = "modifyDiscoveryRes", propOrder = {
    "token",
    "info"
})
public class ModifyDiscoveryRes {

    @XmlElementRef(name = "token", namespace = "http://impl.instance.dev.bsm.mocha.com/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> token;
    @XmlElementRef(name = "info", namespace = "http://impl.instance.dev.bsm.mocha.com/", type = JAXBElement.class, required = false)
