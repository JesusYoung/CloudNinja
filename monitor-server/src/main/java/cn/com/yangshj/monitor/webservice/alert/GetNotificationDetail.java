...
/**
 * <p>getNotificationDetail complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="getNotificationDetail">
 *   &lt;complexContent>
...
@XmlType(name = "getNotificationDetail", propOrder = {
    "token",
    "eventDataId",
    "instanceId"
})
public class GetNotificationDetail {
    ...
    @XmlElementRef(name = "eventDataId", namespace = "http://impl.notification.dev.bsm.mocha.com/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> eventDataId;
    @XmlElementRef(name = "instanceId", namespace = "http://impl.notification.dev.bsm.mocha.com/", type = JAXBElement.class, required = false)
