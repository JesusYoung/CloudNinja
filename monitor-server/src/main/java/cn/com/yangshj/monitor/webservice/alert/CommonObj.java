...
/**
 * <p>CommonObj complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="CommonObj">
 *   &lt;complexContent>
...
@XmlType(name = "CommonObj", namespace = "http://obj.dev.bsm.mocha.com", propOrder = {
    "actionFlag",
    "loginResult"
})
public class CommonObj {

    @XmlElementRef(name = "actionFlag", namespace = "http://obj.dev.bsm.mocha.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> actionFlag;
     ...
     *     
     */
    public JAXBElement<String> getActionFlag() {
        return actionFlag;
    }
     ...
     *     
     */
    public void setActionFlag(JAXBElement<String> value) {
