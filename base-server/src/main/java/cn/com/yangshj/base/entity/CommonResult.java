...
import cn.com.yangshj.base.api.IErrorCode;
...
public class CommonResult<T> {
    ...
    public void checkResponse(String message) {
        if (!Objects.equals(code, ResultCode.SUCCESS.getCode())) {
            throw new ApiException(message + this.message);
        }
    }
}
